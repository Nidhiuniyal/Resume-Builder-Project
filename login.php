...
<div class="d-flex align-items-center" style="height:100vh">
    <div class="w-100">
        <main class="form-signin w-200 m-auto bg-dark text-bg-dark shadow rounded">
            <form method="post" action="actions/login.action.php">
                ...
                <div class="form-floating text-bg-light mb-4">
                ...
                <button class="btn btn-light w-100 py-2" type="submit">Login
