...
?>
    ...
    <div class="container">
        ...
        <div class="bg-dark text-bg-dark rounded shadow p-2 mt-4" style="min-height:80vh">
            ...
            <div>
                ...
                <form action="actions/createresume.action.php" method="post" class="row g-3 p-3 bg-dark text-bg-dark">
                     <div class="col-md-6">
                    ...
                    <h5 class="mt-3 text-secondary"><i class="bi bi-person-circle"></i> Personal Information</h5>
                    <div class="col-md-6">
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-light"><i class="bi bi-floppy"></i> Add
                            Resume</button>
                    </div>
                </form>
            </div>
