...
<div class="d-flex align-items-center" style="height:100vh">
    <div class="w-100">
        <main class="form-signin w-100 m-auto bg-dark text-bg-dark shadow rounded">
            <form method="post" action="actions/register.action.php">
                ...
                <div class="form-floating text-bg-light mb-1">
                ...
                <button class="btn btn-light w-100 py-2" type="submit"><i class="bi bi-person-plus-fill"></i> Register
                </button>
